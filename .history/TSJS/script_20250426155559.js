...
async function trainAndSaveModel() {
  ...
  const { images: trainImages, labels: trainLabels } = mnist.train.nextBatch(55000);
  const { images: testImages, labels: testLabels } = mnist.test.nextBatch(10000);
  ...
  await m.fit(trainImages, trainLabels, {
    batchSize: 512,
    epochs: 10,
