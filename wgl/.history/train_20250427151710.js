...
//     // Explicitly set dtype as 'float32' when creating tensors
//     const trainX = tf.tensor2d(trainingSet.map(d => d.input), [8000, 784], 'float32');
//     const trainY = tf.tensor2d(trainingSet.map(d => d.output), [8000, 10], 'float32');
//     const testX = tf.tensor2d(testSet.map(d => d.input), [1756, 784], 'float32');
//     const testY = tf.tensor2d(testSet.map(d => d.output), [1756, 10], 'float32');
